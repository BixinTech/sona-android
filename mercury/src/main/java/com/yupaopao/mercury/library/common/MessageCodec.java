...
public final class MessageCodec {
    ...
    private static final int MIN_BODY_SIZE_TO_COMPRESS = 248;
    ...
    public static AccessMessage decode(ByteBuf buf) throws Exception {
        ...
        try {
            ...
            for (int i = 0; i < headerCount; i++) {
                ...
                if (buf.readableBytes() < headerLength) {
                    throw new Exception("given header len is wrong, curHeaderType=" + headerType + ", headerLength=" + headerLength + ", current ByteBuf length=" + buf.readableBytes());
                }
            ...
            throw new Exception("msg decoder failed!", e);
        }
    }
